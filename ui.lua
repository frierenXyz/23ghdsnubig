-- Burat UI Library - Tema Azul Neon Minimalista Completo com Paleta de Cores
...
local old_Burat = CoreGui:FindFirstChild('Burat')

if old_Burat then
    Debris:AddItem(old_Burat, 0)
end

if not isfolder("Burat") then
    makefolder("Burat")
end
...
-- TEMA VERMELHO NEON - FACILMENTE MODIFICÁVEL
local ThemeColors = {
    -- Cores principais - modifique aqui para alterar todo o tema
    Primary = Color3.fromRGB(255, 0, 80),          -- Vermelho neon principal
    PrimaryDark = Color3.fromRGB(180, 0, 50),       -- Vermelho escuro
    PrimaryLight = Color3.fromRGB(255, 100, 150),  -- Vermelho claro
    Accent = Color3.fromRGB(255, 50, 150),         -- Vermelho neon/accent
    
    -- Cores de fundo
    Background = Color3.fromRGB(15, 5, 10),         -- Fundo principal com tom vermelho escuro
    SecondaryBg = Color3.fromRGB(20, 10, 15),       -- Fundo secundário
    TertiaryBg = Color3.fromRGB(30, 15, 20),       -- Fundo terciário
    Border = Color3.fromRGB(60, 20, 30),            -- Bordas com tom vermelho
    
    -- Cores de texto
    TextPrimary = Color3.fromRGB(255, 240, 245),    -- Texto primário com tom quente
    TextSecondary = Color3.fromRGB(230, 200, 210),  -- Texto secundário
    TextDisabled = Color3.fromRGB(150, 100, 120),    -- Texto desabilitado
    
    -- Cores de status
    Success = Color3.fromRGB(100, 255, 100),        -- Sucesso (verde)
    Error = Color3.fromRGB(255, 100, 100),          -- Erro (vermelho mais claro)
...
function Library:create_ui()
    ...
    local Burat = Instance.new('ScreenGui')
    Burat.ResetOnSpawn = false
    Burat.Name = 'Burat'
    Burat.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    Burat.Parent = CoreGui
    ...
    ClientName.Text = 'Burat'
    ClientName.Name = 'Burat'
    ...
    function self:UIVisiblity()
        Burat.Enabled = not Burat.Enabled
    end
    ...
    function self:load()
        local content = {}
        for _, object in Burat:GetDescendants() do
    ...
    function self:create_tab(title, icon)
        ...
        function TabManager:create_module(settings)
            ...
            if not settings.rich then
                ...
                ModuleName.Text = settings.richtext or "<font color='rgb(0,150,255)'>Burat</font> Module"
            end
